...
/**
 *  该类定义了画板中的一些列设置参数，例如画板颜色，是否显示标签，是否显示边等等
...
public class VizConfig {
    ...
    public static final Font DEFAULT_NODE_LABEL_FONT = new Font("宋体", Font.BOLD, 48);
    public static final Font DEFAULT_EDGE_LABEL_FONT = new Font("宋体", Font.BOLD, 48);
    ...
    public static final float DEFAULT_EDGE_SCALE = 30f;
...
//    protected Font defaultNodeLabelFont = Font.decode("宋体");
//    protected Font defaultEdgeLabelFont = Font.decode("宋体");
