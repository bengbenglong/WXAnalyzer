...
public class SelectorDriver {
    ...
    public ResultSet getGroupListWithTime(String startTime, String endTime){
        String sql="select * from TB_WX_GROUP where UPDATETIME > '"+startTime+"' AND UPDATETIME < '"+endTime+"'";
        return this.execute(sql);
    }
    
    public ResultSet getFriendListWithTime(String startTime,String endTime){
        String sql="select ACCOUNT,NUMBERTYPE,AUDITTYPE,CMDID from TB_AUDIT where AUDITTYPE='2' and ( AUDITRESULT='1' or AUDITRESULT='-2') and APPLYTIME > '"+startTime+"' and APPLYTIME < '"+endTime+"'";
        return this.execute(sql);
    }
    ...
    public ResultSet getFriendsList(){
        String sql="select ACCOUNT,NUMBERTYPE,AUDITTYPE,CMDID from TB_AUDIT where AUDITTYPE='2' and ( AUDITRESULT='1' or AUDITRESULT='-2') ";
        return this.execute(sql);
    }
