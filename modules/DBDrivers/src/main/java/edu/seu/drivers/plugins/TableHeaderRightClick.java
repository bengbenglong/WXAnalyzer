...
public class TableHeaderRightClick {
    ...
    public TableHeaderRightClick(final JTable jTable,final int column){
        ...
        JMenuItem filterM=new JMenuItem("过滤",new ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/filter_16.png")));
                ...
                SwingUtilities.invokeLater(new Runnable(){
                    ...
                    public void run() {
                        String keywords=(String)JOptionPane.showInputDialog(
                                ...
                                new ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/filter_32.png")),
                                null,
                                null
                        );
                        if(keywords!=null){
                ...
                SwingUtilities.invokeLater(new Runnable(){
                    ...
                    public void run() {
                        ...
                        int num=JOptionPane.showConfirmDialog(
                                    ...
                                    new ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/warning_32.png")));
