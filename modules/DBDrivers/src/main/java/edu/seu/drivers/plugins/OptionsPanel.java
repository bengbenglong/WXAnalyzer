...
public class OptionsPanel extends javax.swing.JPanel {
                ...
                if(!startTimeField.getText().equals("----年--月--日")&&!endTimeField.getText().equals("----年--月--日")){
                    if(startTimeField.getText().compareTo(endTimeField.getText())>0){
                        ...
                        SwingUtilities.invokeLater(new Runnable(){
                            @Override
                            public void run(){
                                JOptionPane.showMessageDialog(null,"结束时间不能早于开始时间","警告",JOptionPane.ERROR_MESSAGE,ImageUtilities.loadImageIcon("edu/seu/lizhenglong/drivers/image/warning_32.png", false));
    ...
    private void initComponents() {
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(OptionsPanel.class, "OptionsPanel.jLabel2.text")); // NOI18N
        ...
        startTimeField.setText(org.openide.util.NbBundle.getMessage(OptionsPanel.class, "OptionsPanel.startTimeField.text")); // NOI18N

        jLabel3.setFont(new java.awt.Font("微软雅黑", 0, 15)); // NOI18N
        jLabel3.setText(org.openide.util.NbBundle.getMessage(OptionsPanel.class, "OptionsPanel.jLabel3.text")); // NOI18N

        endTimeField.setFont(new java.awt.Font("微软雅黑", 0, 15)); // NOI18N
        endTimeField.setText(org.openide.util.NbBundle.getMessage(OptionsPanel.class, "OptionsPanel.endTimeField.text")); // NOI18N

        resetButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/reset_16.png"))); // NOI18N
        resetButton.setText(org.openide.util.NbBundle.getMessage(OptionsPanel.class, "OptionsPanel.resetButton.text")); // NOI18N
        resetButton.setContentAreaFilled(false);
        resetButton.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/reset_16_dark.png"))); // NOI18N
        resetButton.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/lizhenglong/drivers/image/reset_16_dark.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tableComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
