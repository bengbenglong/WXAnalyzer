...
public class RightClickMenu {
    ...
    public RightClickMenu(final JTable jTable){
        ...
        JMenuItem selectAllM=new JMenuItem("全选",ImageUtilities.loadImageIcon("edu/seu/lizhenglong/image/select.png", false));
        ...
        JMenuItem copyM=new JMenuItem("复制",ImageUtilities.loadImageIcon("edu/seu/lizhenglong/image/copy.png", false));
        ...
        JMenuItem clearAllM=new JMenuItem("清空",ImageUtilities.loadImageIcon("edu/seu/lizhenglong/image/delete.png", false));
