 ...
 */
package edu.seu.lizhenglong.mylabperspective.apiimpl;

import edu.seu.lizhenglong.mylabperspective.MyLabPerspectiveTopComponent;
...
public class LabPerDataAccessorImpl implements LabPerDataAccessor{
    ...
    private MyLabPerspectiveTopComponent myLabPer;
    ...
    private void initMyLabPer(){
        myLabPer=MyLabPerspectiveTopComponent.getInstance();
    }
