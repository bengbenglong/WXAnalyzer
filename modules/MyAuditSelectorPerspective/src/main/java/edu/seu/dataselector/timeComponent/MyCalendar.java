...
import edu.seu.dataselector.oldPerspective.*;
...
public class MyCalendar extends JPanel {
    ...
    public static MyCalendar getInstance(String format) {
            return new MyCalendar(format);
    }

    public static MyCalendar getInstance(Date date, String format) {
            return new MyCalendar(date, format);
    }
    ...
    private MyCalendar(Date date) {
        this(date, "yyyy年MM月dd日");
    }

    private MyCalendar(String format) {
        this(new Date(), format);
    }

    private MyCalendar(Date date, String format) {
        initDate = date;
    ...
    private class JP4 extends JPanel {
        ...
        public JP4() {
            ...
            final JLabel jl = new JLabel("选择今日: " + sdf.format(new Date()));
...
//        MyCalendar dateChooser1 = MyCalendar.getInstance("yyyy-MM-dd");
//        MyCalendar dateChooser2 = MyCalendar.getInstance("yyyy-MM-dd");
