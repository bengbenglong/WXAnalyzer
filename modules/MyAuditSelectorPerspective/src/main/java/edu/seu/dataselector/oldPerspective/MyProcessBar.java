...
//        this.setVisible(true);
    ...
    public void setCustomContent(final String content){
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run() {
                processBarLabel.setVisible(true);
                cancelButton.setVisible(true);
                resultNumLabel.setVisible(true);
                resultNumLabel.setText(content);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        processBarLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/processBar.gif"))); // NOI18N

        cancelButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/Cancel_16.png"))); // NOI18N
        cancelButton.setContentAreaFilled(false);
        cancelButton.setPreferredSize(new java.awt.Dimension(22, 22));
        cancelButton.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/cancel_16_red.png"))); // NOI18N
        cancelButton.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/cancel_16_red.png"))); // NOI18N
