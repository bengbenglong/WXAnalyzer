...
public class TableHeaderRightClick {
    ...
    public TableHeaderRightClick(final JTable jTable,final int column){
        ...
        JMenuItem filterM=new JMenuItem("过滤",new ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/filter_16.png")));
                ...
                SwingUtilities.invokeLater(new Runnable(){
                    ...
                    public void run() {
                        String keywords=(String)JOptionPane.showInputDialog(
                                ...
                                new ImageIcon(getClass().getResource("/edu/seu/dataselector/oldPerspective/filter_32.png")),
                                null,
                                null
                        );
                        if(keywords!=null){
