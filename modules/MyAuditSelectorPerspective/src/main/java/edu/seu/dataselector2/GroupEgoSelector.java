 ...
 * @author hp-6380
 */
public class GroupEgoSelector extends javax.swing.JPanel {

    private final String egoGroupNet="单一群组共享成员网络";
    private Color blueColor=new Color(0,150,255);
    
    private volatile static GroupEgoSelector instance;
     ...
     */
    private GroupEgoSelector() {
        initLookAndFeel();
        initComponents();
        initAction();
    }
    
    public static synchronized GroupEgoSelector getInstance(){
        if(instance==null){
            instance=new GroupEgoSelector();
        }
        return instance;
    }
                ...
                new SwingWorker<Void,Void>(){
                    ...
                    protected Void doInBackground() throws Exception {
                        ...
                        if(selectedRow.length>1){
                            JOptionPane.showMessageDialog(null, "您选择了多个群，该系统将只构建第一个群的二阶关系网络，忽略其他群。", "提示", JOptionPane.INFORMATION_MESSAGE);
                        }
...
//进行节点布局
    ...
    private String buildEgoNet(){
        ...
        String selectedGrpupName=(String)table.getValueAt(selectedRow[0],groupNameIndex );
...
//                    }
                ...
                if(graph.getNode(userId)==null){
                    ...
                    for(int i=0;i<columnName.length;i++){
                        if(!columnName[i].equals("USERID")&&!columnName[i].equals("GROUPID")){//因为userid和节点的id是重复的，所以不必重复添加
                            n.setAttribute(columns[i], rs.getString(columnName[i]));
                        }
                    }
...
//            graph.setAttribute("GraphDes", "群“"+selectedGroupId+"”的共享成员网络");
            graph.setAttribute("GraphDes", "群“"+selectedGrpupName+"”的共享成员网络");
            ...
            //更改workspace名字
            String groupName=(String) graph.getNode(selectedGroupId).getAttribute("GROUPID");
            if(groupName==null){
...
//            ResultSet rs=keywordSelector.getGroupList();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buildNetButton, "构建群的共享成员网络"); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(resultNum, org.openide.util.NbBundle.getMessage(GroupEgoSelector.class, "GroupEgoSelector.resultNum.text")); // NOI18N
        ...
        timeSelectorButton.setToolTipText(org.openide.util.NbBundle.getMessage(GroupEgoSelector.class, "GroupEgoSelector.timeSelectorButton.toolTipText")); // NOI18N
