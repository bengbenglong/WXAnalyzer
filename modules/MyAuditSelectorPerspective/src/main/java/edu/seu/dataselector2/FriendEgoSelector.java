 ...
 * @author hp-6380
 */
public class FriendEgoSelector extends javax.swing.JPanel {

    public final String egoFriendNet="单一关联人二阶关系网络";
    private volatile static FriendEgoSelector instance;
...
//        }.execute();
    ...
    public static synchronized FriendEgoSelector getInstance(){
        if(instance==null){
            instance=new FriendEgoSelector();
        }
        return instance;
    }
...
//                            JOptionPane.showConfirmDialog(null, "您选择了多个关联人，该系统将只构建第一个关联人的二阶关系网络，忽略其他关联人", "提示", JOptionPane.YES_OPTION);
                            JOptionPane.showMessageDialog(null, "您选择了多个关联人，该系统将只构建第一个关联人的二阶关系网络，忽略其他关联人。", "提示", JOptionPane.INFORMATION_MESSAGE);
                        }
...
//                    }
                ...
                if(graph.getNode(userId)==null){
                    ...
                    for(int i=0;i<columns.length;i++){
                        if(rs.getString(columnName[i])!=null&&!columnName[i].equals("FRIENDID")){
                            n.setAttribute(columns[i], rs.getString(columnName[i]));
                        }   
                    }
...
//            JOptionPane.showMessageDialog(null, "出现错误");
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(buildNetButton, "构建关联人二阶关系网络"); // NOI18N
        ...
        searchButton.setToolTipText(org.openide.util.NbBundle.getMessage(FriendEgoSelector.class, "FriendEgoSelector.searchButton.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(resultNum, org.openide.util.NbBundle.getMessage(FriendEgoSelector.class, "FriendEgoSelector.resultNum.text")); // NOI18N
        ...
        timeSelectorButton.setToolTipText(org.openide.util.NbBundle.getMessage(FriendEgoSelector.class, "FriendEgoSelector.timeSelectorButton.toolTipText")); // NOI18N
