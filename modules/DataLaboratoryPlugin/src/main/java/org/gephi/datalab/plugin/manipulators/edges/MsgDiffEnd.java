 ...
 * @author hp-6380
 */
public class MsgDiffEnd extends BasicEdgesManipulator{
    MsgDiff msgDiff;
    ...
    public boolean canExecute() {
        ...
        if(gc!=null&&gc.getGraphModel()!=null&&gc.getGraphModel().getGraph().getEdgeCount()>0){
            ...
            return graphDes.contains("消息传播")&&msgDiff.isRunning();
        }else{
            return false;
        }
    }
    ...
    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon("edu/seu/datalab/plugin/images/stop.png", false);
    }
}
