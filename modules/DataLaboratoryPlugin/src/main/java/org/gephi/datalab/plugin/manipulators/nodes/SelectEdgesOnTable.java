...
//                this.edges=dgraph.getOutEdges(node).toArray();
//            }else{
//                this.edges=graph.getEdges(node).toArray();
//            }
        }
    }
    ...
    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon("org/gephi/datalab/plugin/manipulators/resources/items/line16.png", false);
    }
}
