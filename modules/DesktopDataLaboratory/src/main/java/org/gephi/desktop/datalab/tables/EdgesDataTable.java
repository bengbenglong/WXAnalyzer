...
public final class EdgesDataTable extends AbstractElementsDataTable<Edge> {
    ...
    private final PropertyDataColumn<Edge> SOURCE_COLUMN = new PropertyDataColumn<Edge>("源") {
    ...
    private final PropertyDataColumn<Edge> TARGET_COLUMN = new PropertyDataColumn<Edge>("目标") {
